...
export const SITE = {
  ...
  keywords: [
    ...
    "structural steel fabrication India",
    "pressure vessel manufacturer Pune",
    "sugar plant equipment manufacturer",
    "conveyor system manufacturer India",
    "PEB structures fabrication",
    "industrial machinery manufacturing Maharashtra",
    "heavy fabrication company Jejuri",
    "steel fabrication contractor India",
    "metro girder fabrication",
    "industrial silo manufacturer",
    "hopper manufacturer India",
    "tank fabrication Pune",
    "KFab Infra Project",
    "fabrication company Maharashtra",
    "structural fabrication contractor",
    "industrial steel works India",
  ],
  locale: "en_IN",
  type: "website",
