...
import { Zap, Users, Ruler, Cog, Gauge, HardHat } from "lucide-react";

const stats = [
  { icon: Ruler, value: "15,000", label: "Sq Ft Facility", suffix: "+" },
  { icon: Zap, value: "500", label: "KVA Power", suffix: "" },
  { icon: Users, value: "50", label: "Skilled Workers", suffix: "+" },
  { icon: Cog, value: "20", label: "Machines", suffix: "+" },
];
        ...
        <div className="container mx-auto px-4 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-lg text-creme/70 leading-relaxed">
              ...
              and skilled workforce to handle any fabrication challenge.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal direction="right">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                in the industrial heart of Gujarat, providing excellent connectivity
                to ports and major industrial hubs across India.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                Equipped with heavy-duty cranes, precision cutting machines, and
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Climate-controlled quality testing area",
                  "Raw material storage with inventory management",
                  "Dispatch area with loading capacity up to 50T",
                ].map((feature, index) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal>
              ...
              <p className="text-creme/70 leading-relaxed mb-6">
                Strategically located in Gujarat's industrial corridor with
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Manufacturing Unit</h4>
